...
[ExecuteInEditMode]
public class WorlyNoise : MonoBehaviour {
    ...
    public virtual void Generate() {
        ...
        if (is3D) {
            tempRenderTexture2D = new RenderTexture(4, 4, 0, RenderTextureFormat.ARGB32);
            tempRenderTexture2D.enableRandomWrite = true;

            tempRenderTexture3D = new RenderTexture(resolution, resolution, 0, RenderTextureFormat.ARGB32);
            ...
            tempRenderTexture2D = new RenderTexture(resolution, resolution, 0, RenderTextureFormat.ARGB32);
            tempRenderTexture2D.wrapMode = TextureWrapMode.Repeat;
            tempRenderTexture2D.filterMode = FilterMode.Bilinear;
            tempRenderTexture2D.enableRandomWrite = true;

            tempRenderTexture3D = new RenderTexture(4, 4, 0, RenderTextureFormat.ARGB32);
            tempRenderTexture3D.dimension = UnityEngine.Rendering.TextureDimension.Tex3D;
            tempRenderTexture3D.enableRandomWrite = true;
        }
